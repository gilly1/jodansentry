<div>
    <div class="mb-6">
        ...
        <h1 class="text-xl font-semibold text-slate-900 mt-2">Edit User</h1>
    ...
    <div class="bg-white rounded-xl border border-slate-200 p-6 max-w-lg">
        <form wire:submit="update" class="space-y-4">
            ...
            <div class="flex items-center gap-3 pt-2">
                <button type="submit" class="rounded-lg bg-slate-900 px-4 py-2 text-sm font-medium text-white hover:bg-slate-800 transition">Update User</button>
